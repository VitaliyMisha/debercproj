                ...
                <div className="space-y-4">
                    {rounds
                        ...
                        .map(round => (
                            <div
                                key={round.number}
                                className="relative bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-xl p-4 hover:shadow-lg hover:bg-white/90 transition-all duration-300"
                            >
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            <h3 className="text-lg font-medium bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                                                Редагування раунду {round.number}
                                            </h3>
                                        </div>
