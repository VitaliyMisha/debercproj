...
Проєкт у робочому стані. Тестів: **176** (усі зелені). Lint (Biome 2.5) та type-check (tsc) — чисті. У `main` уже влиті правки правил гри та оновлення залежностей; у роботі гілка `worktree-rules-sheet` (екран правил).

### Екран правил у застосунку (2026-09-08)

Гілка `worktree-rules-sheet`. Тестів: 168 → **176**.
